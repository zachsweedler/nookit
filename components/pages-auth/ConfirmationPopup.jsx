   ...
   return (
      <Wrapper>
         <>
            ...
            <Para weight="regular" size="textxl">
               Please check your inbox for a login link.
            </Para>
            <NoteWrapper>
            <Para weight="medium" size="textmd">Heads Up!</Para>
            <Para weight="regular" size="textmd">
...
const NoteWrapper = styled.div`
   ...
   border-left: 5px solid ${({ theme }) => theme.color.primary.brand.b600};
