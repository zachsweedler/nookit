...
export default function GuestBookings({bookings, authUserId}) {
   ...
   const guestBookings = bookings.filter((booking) => booking.guest_user_id === authUserId);
               ...
               <>
                  ...
                  {guestBookings.map((booking) => (
                     <BookingRow
                        ...
                        bookingPriceTotalBeforeTax={booking.booking_price_total_before_taxes}
                        processingFee={booking.processing_fee}
                        hostPayout={booking.booking_price - booking.processing_fee}
