...
export default function Terms() {
   const content = () => (
      <>
         Agreement between User and nookit.app:
         <br />
         <br />
         Welcome to nookit.app. The nookit.app website (the &quot;Site&quot;) is comprised
         of various web pages operated by Zachary Ryan Enterprises, LLC (&quot;ZRE&quot;).
         nookit.app is offered to you conditioned on your acceptance without
         modification of the terms, conditions, and notices contained herein
         (the &quot;Terms&quot;). Your use of nookit.app constitutes your agreement to all
         such Terms. Please read these terms carefully, and keep a copy of them
         for your reference.
         <br />
         <br />
         nookit.app is a Store-Within-A Store Booking Service Site.
         <br />
         <br />
         Nookit is a website where brands can book a &quot;nook&quot; within another
         brand&apos;s storefront. This allows brands to pop-in in enviroments that
         align with their image, offering a collaborative brand experiences for
         in-store customers.
         <br />
         <br />
         Privacy
         <br />
         Your use of nookit.app is subject to ZRE&apos;s Privacy Policy. Please
         ...
         <br />
         Visiting nookit.app or sending emails to ZRE constitutes electronic
         ...
         entity. You acknowledge that ZRE is not responsible for third party
         access to your account that results from theft or misappropriation of
         your account. ZRE and its associates reserve the right to refuse or
         ...
         <br />
         ZRE does not knowingly collect, either online or offline, personal
         information from persons under the age of thirteen. If you are under
         18, you may use nookit.app only with permission of a parent or
         guardian.
         <br />
         <br />
         Cancellation/Refund Policy
         <br />
         You may cancel your booking at any time. You can cancel until 5 days
         before the start date of the booking for a full refund. Otherwise, you
         will not qualify for a refund. Please contact us at contact@nookit.com
         with any questions.
         <br />
         <br />
         Links to Third Party Sites/Third Party Services
         <br />
         nookit.app may contain links to other websites (&quot;Linked Sites&quot;). The
         Linked Sites are not under the control of ZRE and ZRE is not
         ...
         updates to a Linked Site. ZRE is providing these links to you only as a
         convenience, and the inclusion of any link does not imply endorsement
         by ZRE of the site or any association with its operators.
         <br />
         <br />
         Certain services made available via nookit.app are delivered by third
         party sites and organizations. By using any product, service or
         functionality originating from the nookit.app domain, you hereby
         acknowledge and consent that ZRE may share such information and data
         with any third party with whom ZRE has a contractual relationship to
         provide the requested product, service or functionality on behalf of
         nookit.app users and customers.
         <br />
         <br />
         No Unlawful or Prohibited Use/Intellectual Property
         <br />
         You are granted a non-exclusive, non-transferable, revocable license to
         access and use nookit.app strictly in accordance with these terms of
         use. As a condition of your use of the Site, you warrant to ZRE that
         ...
         used on the Site, is the property of ZRE or its suppliers and protected
         ...
         any of the content, in whole or in part, found on the Site. ZRE content
         is not for resale. Your use of the Site does not entitle you to make
         ...
         written permission of ZRE and the copyright owner. You agree that you
         do not acquire any ownership rights in any protected content. We do not
         grant you any licenses, express or implied, to the intellectual
         property of ZRE or our licensors except as expressly authorized by
         these Terms.
         <br />
         <br />
         ...
         necessary consents; upload files that contain viruses, corrupted files,
         or any other similar software or programs that may damage the operation
         of another&apos;s computer; advertise or offer to sell or buy any goods or
         ...
         or other material contained in a file that is uploaded; restrict or
         ...
         <br />
         <br />
         ZRE has no obligation to monitor the Communication Services. However,
         ZRE reserves the right to review materials posted to a Communication
         Service and to remove any materials in its sole discretion. ZRE
         ...
         <br />
         <br />
         ZRE reserves the right at all times to disclose any information as
         ...
         information or materials, in whole or in part, in ZRE&apos;s sole
         discretion.
         <br />
         <br />
         ...
         Service. ZRE does not control or endorse the content, messages or
         information found in any Communication Service and, therefore, ZRE
         ...
         Communication Service. Managers and hosts are not authorized ZRE
         spokespersons, and their views do not necessarily reflect those of ZRE.
         <br />
         <br />
         ...
         <br />
         <br />
         Materials Provided to nookit.app or Posted on Any ZRE Web Page
         <br />
         ZRE does not claim ownership of the materials you provide to nookit.app
         (including feedback and suggestions) or post, upload, input or submit
         to any ZRE Site or our associated services (collectively
            &quot;Submissions&quot;). However, by posting, uploading, inputting, providing or
         submitting your Submission you are granting ZRE, our affiliated
         ...
         translate and reformat your Submission; and to publish your name in
         connection with your Submission.
         <br />
         <br />
         No compensation will be paid with respect to the use of your
         Submission, as provided herein. ZRE is under no obligation to post or
         use any Submission you may provide and may remove any Submission at any
         time in ZRE&apos;s sole discretion.
         <br />
         <br />
         ...
         <br />
         You will be able to connect your ZRE account to third party accounts.
         By connecting your ZRE account to your third party account, you
         ...
         International Users
         <br />
         The Service is controlled, operated and administered by ZRE from our
         ...
         laws. You agree that you will not use the ZRE Content accessed through
         nookit.app in any country or in any manner prohibited by any applicable
         laws, restrictions or regulations.
         <br />
         <br />
         Indemnification
         <br />
         You agree to indemnify, defend and hold harmless ZRE, its officers,
         ...
         your violation of any applicable laws, rules or regulations. ZRE
         ...
         in which event you will fully cooperate with ZRE in asserting any
         available defenses.
         <br />
         <br />
         Arbitration
         ...
         Further, unless both you and ZRE agree otherwise, the arbitrator may
         ...
         ZACHARY RYAN ENTERPRISES, LLC AND/OR ITS SUPPLIERS MAY MAKE
         IMPROVEMENTS AND/OR CHANGES IN THE SITE AT ANY TIME.
         <br />
         <br />
         ZACHARY RYAN ENTERPRISES, LLC AND/OR ITS SUPPLIERS MAKE NO
         ...
         WITHOUT WARRANTY OR CONDITION OF ANY KIND. ZACHARY RYAN ENTERPRISES,
         ...
         ZACHARY RYAN ENTERPRISES, LLC AND/OR ITS SUPPLIERS BE LIABLE FOR ANY
         ...
         USE THE SITE OR RELATED SERVICES, THE PROVISION OF OR FAILURE TO
         ...
         NEGLIGENCE, STRICT LIABILITY OR OTHERWISE, EVEN IF ZACHARY RYAN
         ENTERPRISES, LLC OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE
         ...
         <br />
         ZRE reserves the right, in its sole discretion, to terminate your
         ...
         agreement is governed by the laws of the State of New York and you
         hereby consent to the exclusive jurisdiction and venue of courts in New
         York in all disputes arising out of or relating to the use of the Site.
         ...
         relationship exists between you and ZRE as a result of this agreement
         or use of the Site. ZRE&apos;s performance of this agreement is subject to
         existing laws and legal process, and nothing contained in this
         agreement is in derogation of ZRE&apos;s right to comply with governmental,
         court and law enforcement requests or requirements relating to your use
         of the Site or information provided to or gathered by ZRE with respect
         to such use. If any part of this agreement is determined to be invalid
         ...
         entire agreement between the user and ZRE with respect to the Site and
         ...
         ZRE with respect to the Site. A printed version of this agreement and
         ...
         Changes to Terms
         <br />
         ZRE reserves the right, in its sole discretion, to change the Terms
         under which nookit.app is offered. The most current version of the
         Terms will supersede all previous versions. ZRE encourages you to
         periodically review the Terms to stay informed of our updates.
         <br />
         <br />
         Contact Us
         <br />
         ZRE welcomes your questions or comments regarding the Terms:
         <br />
         <br />
         Zachary Ryan Enterprises, LLC
         <br />
         15 Riverside Ave
         <br />
   ...
   return <LegalPage title="Terms" content={content()} />;
}
